...
class PlayerTransform extends Transform {
    ...
    PlayerTransform(float speed, float objectWidth,
    ...
    public void updateColliders(){
        ...
        mColliders.get(0).top = location.y + objectHeight -
                (objectHeight * TENTH);
        mColliders.get(0).right = location.x + objectWidth -
                (objectWidth * THIRD);
        mColliders.get(0).bottom = location.y + objectHeight +
                (objectHeight * FEET_PROTRUSION);

        // Head
        mColliders.get(1).left = location.x + (objectWidth * THIRD);
        mColliders.get(1).top =  location.y;
        mColliders.get(1).right = location.x + objectWidth -
                (objectWidth * THIRD);
        mColliders.get(1).bottom = location.y + (objectHeight * TENTH);

        // Right
        mColliders.get(2).left = location.x + objectWidth -
                (objectWidth * TENTH);
        ...
        mColliders.get(2).bottom = location.y +
                (objectHeight - (objectHeight * HALF));
        ...
        mColliders.get(3).bottom = location.y +
                (objectHeight - (objectHeight * FIFTH));
    }
