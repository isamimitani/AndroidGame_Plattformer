...
class BitmapStore {
    ...
    private BitmapStore(Context context){
        ...
        addBitmap(context, "death_visible", new PointF(1, 1), 128, true);
    }
    ...
    static void addBitmap(Context c, String bitmapName, PointF objectSize,
        ...
        int redID = c.getResources().getIdentifier(bitmapName, "drawable",
                c.getPackageName());

        // Load the bitmap using the id
        bitmap = BitmapFactory.decodeResource(c.getResources(), redID);
